...
import trayIcon16 from '../../../resources/trayTemplate.png?asset'
import trayIcon32 from '../../../resources/trayTemplate-32.png?asset'
...
function trayTemplateImage(): Electron.NativeImage {
  // Provide 16pt + 32px (@2x) bitmaps directly — resizing a single asset was
  // soft/blurry in the menu bar.
  const image = nativeImage.createEmpty()
  image.addRepresentation({
    scaleFactor: 1.0,
    width: 16,
    height: 16,
    buffer: readFileSync(trayIcon16)
  })
  image.addRepresentation({
    scaleFactor: 2.0,
    width: 32,
    height: 32,
    buffer: readFileSync(trayIcon32)
  })
